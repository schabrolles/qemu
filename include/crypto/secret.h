...
/* GKU: QAPI compat */
#define QCRYPTO_SECRET_FORMAT_RAW Q_CRYPTO_SECRET_FORMAT_RAW
#define QCRYPTO_SECRET_FORMAT_BASE64 Q_CRYPTO_SECRET_FORMAT_BASE64
#define QCRYPTO_SECRET_FORMAT_MAX Q_CRYPTO_SECRET_FORMAT_MAX
